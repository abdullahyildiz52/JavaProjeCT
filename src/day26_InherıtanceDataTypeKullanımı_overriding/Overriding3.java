package day26_InherıtanceDataTypeKullanımı_overriding;

public class Overriding3 extends Overriding2{
    public void method1(){
        System.out.println("Overriding3 method 1");
    }
    ...
    public static void main(String[] args) {
        ...
        obj1.method1(); // Overriding3 method 1
        obj1.method2(); //  Overrinig2 method 2

        Overriding2 obj2=new Overriding3();
        obj2.method1(); //Overriding3 method 1
        obj2.method2(); // Overrinig2 method 2

        Overriding1 obj3=new Overriding3();
        obj3.method1(); //  Overriding3 method 1
        obj3.method2(); // Overrinig2 method 2
