...
public class C07_Compute {
    public static void main(String[] args) {
        ...
        // A nin degerini 2 katina cikaralim
        ...
        // B varsa degerini 3 artirin
        harfKullanimSayilari.computeIfPresent("B",(k,v)-> v+3); // {A=80, C=25, K=10, M=23, Z=32}
        harfKullanimSayilari.computeIfPresent("M",(k,v)-> v+3); // {A=80, C=25, K=10, M=26, Z=32}
        System.out.println(harfKullanimSayilari);//

        // B yoksa degeri 5 olarak ekleyin
        harfKullanimSayilari.putIfAbsent("B",5); // {A=80, B=5, C=25, K=10, M=26, Z=32}
