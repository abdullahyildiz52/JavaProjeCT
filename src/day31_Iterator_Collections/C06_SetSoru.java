...
public class C06_SetSoru {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(sayilar));// [null, null, null, null, null, null]
        ...
        System.out.println("Arrays in son hali: "+Arrays.toString(sayilar));// Arrays in son hali: [1, 2, 3, 4, 5, 6]
